    ...
    <div class="col-md-4">
           <!-- Bouton Réserver -->             
             <form a method="post" class="btn-container">
                   <button type="submit" name="submit" class="btn btn-primary">Réserver ce voyage</button>
             </form>   
    </div>
    <div class="col-md-4">
        <!-- bouton pour envoyer un message à ce conducteur-->
         <form a method="post" class="btn-container">
                <button type="submit" name="submit"  class="btn btn-primary">Contacter Le conducteur</button>
              </form>
        </div>
