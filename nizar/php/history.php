...
try {
    ...
    CommenterReservation.commentairepassager
    FROM 
        Reserver
    JOIN 
    ...
    LEFT JOIN 
        CommenterReservation ON Reservation.IdRes = CommenterReservation.IdRes
    WHERE 
    ...
    if (!empty($confirmedTrajets)) {
        ...
        foreach ($confirmedTrajets as $trajet) {
            ...
            echo "<p><strong>Commentaire Conducteur:</strong> " . htmlspecialchars($trajet['commentairetrajetconducteur']) . "</p>";
            ...
            echo "<p><strong>Commentaire Passager:</strong> " . htmlspecialchars($trajet['commentairepassager']) . "</p>";
