...
$username = $_SESSION['nom'] ?? 'Visiteur'; // Utilisez 'Visiteur' comme valeur par défaut

// Récupération de tous les trajets disponibles
try {
...
<head>
    ...
    body, html {
        ...
        background: #f5f5f5;
        height: 100%;
        min-height: 100vh; /* Utilisez 100vh pour la hauteur minimum pour s'assurer que le footer reste en bas */
        display: flex;
        flex-direction: column; /* Le body agit comme un conteneur flex */
    }
...
<body>
    ...
    <!-- Section pour afficher les trajets disponibles -->
    <section>
