    ...
    <style>
        * {
        ...
        nav a {
            ...
            color: #38b238; /* Bright green color */
            margin: 0 1em;
            padding: 0.25em 0;
            position: relative;
        }
        ...
        nav a:hover, nav a:focus {
            color: #2d862d; /* Darker green on hover/focus */
        }
        ...
        nav a:before {
            ...
            bottom: 0;
            left: 50%;
            background-color: #38b238; /* Bright green color */
        ...
        .search-fields input, .search-fields button {
            padding: 0.5em;
            margin: 0.5em;
            border: 2px solid #38b238; /* Bright green border */
            border-radius: 5px;
            font-size: 1em;
            outline: none;
        }
        ...
        .search-fields input:focus {
            border-color: #2d862d; /* Darker green on focus */
        }

        .search-button {
            background-color: #38b238; /* Bright green background */
            color: white;
            cursor: pointer;
        }
