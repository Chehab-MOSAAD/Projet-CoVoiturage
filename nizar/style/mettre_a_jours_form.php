...
<div class="container">
   ...
   <form method="POST" action="mettre_a_jours.php">
        ...
        <input type="checkbox" id="handicap" name="handicap" <?php if ($userData['handicap'] == 't') echo 'checked'; ?>><br>
        <label for="fumeur">Fumeur:</label>
        <input type="checkbox" id="fumeur" name="fumeur" <?php if ($userData['fumeur'] == 't') echo 'checked'; ?>><br>
